...
var _Gizra$elm_spa_exmple$PeopleMap_Model$Marker = F3(
	function (a, b, c) {
...
var _Gizra$elm_spa_exmple$People_Model$Person = F6(
	function (a, b, c, d, e, f) {
		return {name: a, image: b, socialNetworks: c, title: d, attributes: e, location: f};
	});
...
var _Gizra$elm_spa_exmple$GizraTeam$people = _Gizra$elm_dictlist$DictList$fromList(
	{
		...
		_0: {
			...
			_1: {
				...
				location: {id: 'amitaibu', lat: 0, lng: 0}
			}
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_1: {
					...
					location: {id: 'bricel', lat: 0, lng: 0}
				}
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: {
						...
						location: {id: 'OritiMG', lat: 0, lng: 0}
					}
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: {
							...
							location: {id: 'IshaDakota', lat: 0, lng: 0}
						}
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: {
								...
								location: {id: 'RachelBaram', lat: 0, lng: 0}
							}
						},
						_1: {
							ctor: '::',
							_0: {
								...
								_1: {
									...
									location: {id: 'LiatSadeSaadon', lat: 0, lng: 0}
								}
							},
							_1: {
								ctor: '::',
								_0: {
									...
									_1: {
										...
										location: {id: 'RoySegall', lat: 0, lng: 0}
									}
								},
								_1: {
									ctor: '::',
									_0: {
										...
										_1: {
											...
											location: {id: 'NaderSafadi', lat: 0, lng: 0}
										}
									},
									_1: {
										ctor: '::',
										_0: {
											...
											_1: {
												...
												location: {id: 'bitamar', lat: 0, lng: 0}
											}
										},
										_1: {
											ctor: '::',
											_0: {
												...
												_1: {
													...
													location: {id: 'ordavidil', lat: 0, lng: 0}
												}
											},
											_1: {
												ctor: '::',
												_0: {
													...
													_1: {
														...
														location: {id: 'efratn', lat: 0, lng: 0}
													}
												},
												_1: {
													ctor: '::',
													...
													_1: {
														...
														_0: {
															...
															_1: {
																...
																location: {id: 'SavyonCohen', lat: 0, lng: 0}
															}
														},
														_1: {
															ctor: '::',
															_0: {
																...
																_1: {
																	...
																	location: {id: 'ybaras', lat: 0, lng: 0}
																}
															},
															_1: {
																ctor: '::',
																_0: {
																	...
																	_1: {
																		...
																		location: {id: 'DavidBronfen', lat: 0, lng: 0}
																	}
																},
																_1: {
																	ctor: '::',
																	_0: {
																		...
																		_1: {
																			...
																			location: {id: 'DavidHernandez', lat: 0, lng: 0}
																		}
																	},
																	_1: {
																		ctor: '::',
																		_0: {
																			...
																			_1: {
																				...
																				location: {id: 'RyanRempel', lat: 0, lng: 0}
																			}
																		},
																		_1: {
																			ctor: '::',
																			_0: {
																				...
																				_1: {
																					...
																					location: {id: 'AronNovak', lat: 0, lng: 0}
																				}
																			},
																			_1: {ctor: '[]'}
																		}
...
var _Gizra$elm_spa_exmple$App_Model$emptyModel = {magnets: _eeue56$elm_all_dict$EveryDict$empty, people: _Gizra$elm_spa_exmple$GizraTeam$people, showMap: true};
var _Gizra$elm_spa_exmple$App_Model$Flags = F2(
	function (a, b) {
		return {randomNumbers: a, selectedMarker: b};
	});
...
var _Gizra$elm_spa_exmple$App_Update$selectedMarker = _elm_lang$core$Native_Platform.incomingPort(
	'selectedMarker',
...
var _Gizra$elm_spa_exmple$PeopleMap_View$viewMap = F2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A2(_Gizra$elm_spa_exmple$PeopleMap_View$viewMap, model.people, model.showMap),
					_1: {ctor: '[]'}
				}
			}
		});
			...
			return A2(
				...
				function (selectedMarker) {
					return _elm_lang$core$Json_Decode$succeed(
						{randomNumbers: randomNumbers, selectedMarker: selectedMarker});
				},
				A2(
