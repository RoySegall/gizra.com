...
When we started working on a mobile web site for [Casa del Lector](https://www.gizra.com/content/casa-del-lector/)'s exhibition, we decided early on it would be a backend-free app, mainly for reasons of stability and performance:
