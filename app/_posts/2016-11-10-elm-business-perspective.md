...
But reading the essence of what Sandy Maguire ([@isovector](http://www.twitter.com/isovector)) wrote, made a few things clear to me:

* [@isovector](http://www.twitter.com/isovector) seems to be a better developer than me. That is, he knows way more about Haskell, type classes, and polymorphism than I know. As one that learns (and struggles) with Haskell, I can really appreciate it.
